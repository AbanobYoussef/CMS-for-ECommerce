...
<div class="box">
 ...
 <div class="box-body">
 	{!!Form::open(['route'=>['manifactories.update',$Manifactory->id],'method'=>'put'])!!}
   ...
   <div>
    ...
    {!!Form::text('Mani_name',$Manifactory->Mani_name,['class'=>'form-control'])!!}
  </div>


  <div>
    {!!Form::label('email','Email')!!}
    {!!Form::email('email',$Manifactory->email,['class'=>'form-control'])!!}
  </div>


  <div>
    {!!Form::label('mobile','Mobile')!!}
    {!!Form::text('mobile',$Manifactory->mobile,['class'=>'form-control'])!!}
  </div>
  ...
  <div>
    ...
    {!!Form::url('facebook',$Manifactory->facebook,['class'=>'form-control'])!!}
  </div>


  <div>
    {!!Form::label('twitter','Twitter Link')!!}
    {!!Form::url('twitter',$Manifactory->twitter,['class'=>'form-control'])!!}
  </div>


  <div>
    {!!Form::label('website','Website Link')!!}
    {!!Form::url('website',$Manifactory->website,['class'=>'form-control'])!!}
  </div>
  ...
  <div>
    ...
    {!!Form::text('contact_name',$Manifactory->contact_name,['class'=>'form-control'])!!}
  </div>
